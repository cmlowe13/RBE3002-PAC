...
if __name__=='__main__':
	...
	global grid,nodes,frontPub,frontier,blobs,pose,nav_pub, odom_list,odom_tf, prev_twist
	grid = OccupancyGrid()
	...
	nav_pub = rospy.Publisher('/mobile_base/commands/velocity',Twist,None,queue_size = 10)
